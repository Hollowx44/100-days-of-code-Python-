word_lists = [
    ...
    "Sweden", "Portugal", "Pakistan", "New Zealand", "Israel", "Ukraine", "Poland", "Norway", "Bangladesh", "Belgium",
    "Ireland", "Denmark", "Qatar", "Iran", "Colombia", "Morocco", "Finland", "Iraq", "Czech Republic", "Chile"
]